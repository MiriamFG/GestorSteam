...
public class JuegoDTO {
    ...
    public JuegoDTO(Long id, String titulo, String descipcion, String desarrollador, LocalDate fechaLanz, double precioBase, int descuentoActual, String categoria, ClasificacionEdad clasificacionEdad, List<String> idiomasDisponibles, EstadoJuego estadoJuego) {
        this.id = id;
        this.titulo = titulo;
