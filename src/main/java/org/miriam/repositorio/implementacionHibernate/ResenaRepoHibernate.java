...
public class ResenaRepoHibernate implements IResenaRepo {
    ...
    public Optional<ResenaEntidad> crear(ResenaForm form) {
        ...
        var resena = new ResenaEntidad(null, form.getIdUsuario(), form.getIdJuego(), form.getRecomendado(), form.getTextoResena(), form.getHorasJuegoResena(), LocalDate.now(), LocalDate.now(), form.getEstado());
