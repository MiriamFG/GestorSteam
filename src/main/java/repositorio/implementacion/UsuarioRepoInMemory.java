...
public class UsuarioRepoInMemory implements IUsuarioRepo {
    ...
    public Optional<UsuarioEntidad> crear(UsuarioForm form) {
         var usuario = new UsuarioEntidad(idCount++, form.getNombreUsuario(), form.getEmail(), form.getContrasena(), form.getNombreReal(), form.getPais(), form.getFechaNac(), LocalDateTime.now(), form.getAvatar(), 0.00, EstadoCuenta.ACTIVA);
    ...
    public Optional<UsuarioEntidad> actualizar(Long id, UsuarioForm form) {
        ...
        var usuarioEncontrado = usuarioOpt.get();

        var usuarioActualizado = new UsuarioEntidad(id,form.getNombreUsuario(), form.getEmail(), form.getContrasena(), form.getNombreReal(), form.getPais(), form.getFechaNac(), usuarioEncontrado.getFechaReg(), form.getAvatar(), usuarioEncontrado.getSaldoCartera(), usuarioEncontrado.getEstadoCuenta());
